...
{
    public class AssignRideToDriverCommandHandler : IRequestHandler<AssignRideToDriverCommand, Result>
    {
        private readonly IDriverRepository _driverRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IDateTimeProvider _dateTimeProvider;

        public AssignRideToDriverCommandHandler(IDriverRepository driverRepository, IUnitOfWork unitOfWork, IDateTimeProvider dateTimeProvider)
        {
        ...
        public async Task<Result> Handle(AssignRideToDriverCommand request, CancellationToken cancellationToken)
        {
            ...
            var assignRideResult = driver.AssignRide(_dateTimeProvider.UtcNow);
